...
<?php
$connect=mysqli_connect("localhost","root","","tamilhacks");
if(!$connect){
...
if(isset($_POST['search'])){
	...
	$textEndDate=$_POST['endDate'];
	$query=mysqli_query($connect,"Select Firs_name,Last_name,Dob,Gender,Section,Standard,Email,Mobile_no from students where Date between '$txtStartDate' and '$textEndDate' ");
